...
'''class contact: 
	...
	def __init__(self,name,phone_number):
		...
		with open (cont_list, 'ab') as f:
			pickle.dump(contact.cont,f)
		...
		f.close()
		f = open(cont_list, 'rb')   #тут у меня говно4
...
menu2 = {11:'add_contact', 22:'edit_contact', 33:'find_contact', 44:'delete_contact'}
'''menu[s]()'''
